...
from QuantaraAI_core.plugins.schemas import BaseToolInput
from QuantaraAI_core.plugins.tools import BaseTool
from QuantaraAI_core.plugins.tools.response_dumper_base import S3ResponseDumper
    ...
    examples=[
        {
            ...
            "response": "",
            "image_url": "https://QuantaraAI-ai-assets.s3.eu-central-1.amazonaws.com/example-images/chart-analyzer.png",
        },
        {
